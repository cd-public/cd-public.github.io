...
```
  - To bits, which the command line attempts to interpret as characters, many of them unprintable.
...
```
user@DESKTOP-THMS2PJ:~/.ssh$
user@DESKTOP-THMS2PJ:~/.ssh$ openssl pkey -in unsafe.pem -pubout out -out unsafe-pub.pem
pkey: Use -help for summary.
user@DESKTOP-THMS2PJ:~/.ssh$ openssl pkey -in unsafe.pem -pubout -out unsafe-pub.pem
user@DESKTOP-THMS2PJ:~/.ssh$ cat unsafe_pub.pem
cat: unsafe_pub.pem: No such file or directory
user@DESKTOP-THMS2PJ:~/.ssh$ ls
known_hosts  known_hosts.old  one.txt  two.txt  unsaf2.pem  unsaf3.pem  unsafe-pub.pem  unsafe.pem
...
user@DESKTOP-THMS2PJ:~/.ssh$ openssl rsa -in unsafe-pub.pem -text
Could not read private key from unsafe-pub.pem
40D770C0657F0000:error:1608010C:STORE routines:ossl_store_handle_load_result:unsupported:../crypto/store/store_result.c:151:
40D770C0657F0000:error:1608010C:STORE routines:ossl_store_handle_load_result:unsupported:../crypto/store/store_result.c:151:
user@DESKTOP-THMS2PJ:~/.ssh$ openssl pkey -in unsafe-pub.pem -text
Could not read key from unsafe-pub.pem
4087B4FDB77F0000:error:1608010C:STORE routines:ossl_store_handle_load_result:unsupported:../crypto/store/store_result.c:151:
4087B4FDB77F0000:error:1608010C:STORE routines:ossl_store_handle_load_result:unsupported:../crypto/store/store_result.c:151:
user@DESKTOP-THMS2PJ:~/.ssh$
user@DESKTOP-THMS2PJ:~/.ssh$
