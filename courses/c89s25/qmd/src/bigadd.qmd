...
- We will use `bigsub` which I am providing for this assignment.
  - I make no claims my `bigsub` is good or anything, but it seemed pretty okay to me.
...
- While insuitable for cryptographic applications for limitations including performance, it is suitable for testing.
...
- It is recommended but not required to develop an interface between Python and your `4096_t`.
  ...
  - Take timing data
- I found it difficult to debug without constructing an interface.
