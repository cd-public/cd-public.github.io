...
- Rather than provide an end-to-end containerized autograder, I am providing the following Makefile:
...
- You may change the compiler from `clang` back to `gcc`, but I wanted to show you clang and Makefile variables.
