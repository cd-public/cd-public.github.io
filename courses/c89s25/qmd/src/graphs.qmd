...
<a style="filter: invert(1);" title="Vector version of Image:Tred-G.png, Public domain, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:Tred-G.svg"><img height="100%" alt="Tred-G" src="https://upload.wikimedia.org/wikipedia/commons/f/fe/Tred-G.svg"></a>
...
* We consider a subset of $C \times C$ that is "safe"

# Safety

* Construst $L$, the traffic light relation
    * Yellow must precede Red
        $$
...
*R⁺* : ∀ *R'* ⊂ *S* × *S*:
*R'* ⊃ *R* and **Transitive**(*R'*) :
|*R⁺*| < |*R'*| and *R⁺* ⊃ *R* and **Transitive**(*R'*)
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Noun_phrase_chunking_with_NLTK.svg/2560px-Noun_phrase_chunking_with_NLTK.svg.png)

* Sentences (S) contain words or phrases, and phrases (*x*P) contain words, but no phrases contain a sentence or words contain a phrase.
