...
- *Use the test with caution outside of contaienrs as it deletes files you may want to preserve*
- The tester:
...
```
  ...
  - Tests RSA for all permutations of C and Python for each stage:
    ...
    - Compares the output.
      - Disregards non-printing characters, which are out of scope.
        - It is a little to easy to have many null-terminators on C output.
        - Don't worry about that.
        - Having the same printing characters is sufficient and appropriate.
