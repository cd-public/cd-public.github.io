...
\item[]\href{https://www.elon.edu/u/academics/arts-and-sciences/computer-science/}{Department of Computer Science}
    \begin{innerlist}
                \item Instructor of Record:~\href{http://elon.smartcatalogiq.com/en/2020-2021/Academic-Catalog/Courses/CSC-Computer-Science/100/CSC-130}{CSC 130 Computer Science I}
    \end{innerlist}
\end{innerlist}
...
\item[]\href{https://cs.unc.edu/}{Department of Computer Science}
    \begin{innerlist}
                \item Instructor of Record:~\href{https://catalog.unc.edu/search/?P=COMP\%20116}{COMP 116 Introduction to Scientific Programming}
    \end{innerlist}
\end{innerlist}
...
\begin{bibenum}
	...
	3rd Annual Side Channel Academic Program Workshop 2021. 11 November 2021.
	
	\item Isadora: Automated Information Flow Property Generation for Hardware Designs.
	Workshop on Secure RISC-V Architecture Design. 7 November 2021.
    ...
    Virtual Research Presentations: Computer Science and Cyber Security.
    22 March, 2021.
    
\end{bibenum}

\section{Open Source Research Tools}
...
\section{Open Source Teaching Materials}
