...
Fostering Equity, Support and Community for Low-Income \hfill {2022 to 2028} \break
...
\begin{bibenum}
	...
	\item[] Aphrodite, an ISA-level RISC spec miner. \\ Willamette University.  \url{https://github.com/wu-jldeyoung/Aphrodite}

	\item[] Isadora, an ISA-level RISC iflow miner.\\ HyperFloGen. \url{https://github.com/cd-public/Isadora}
	
	\item[] Astarte, an ISA-level CISC spec miner.  \\HW Security @ UNC.  \url{https://github.com/cd-public/Astarte}
	
	\item[] Undine, a RTL RISC LTL miner.  \\HW Security @ UNC.  \url{https://github.com/cd-public/Undine}
	
	\item[] Coppelia, an RTL RISC spec miner.\\HW Security @ UNC.  \url{https://github.com/rzhang2285/Coppelia}
...
\begin{bibenum}
	...
	\item[] Inquiry-Based Learning for Equity, Title III Grant Quantitative Reasoning (QR) Summer Learning Circles
