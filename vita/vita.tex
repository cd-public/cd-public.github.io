...
\href{https://willamette.edu/computer-data-science/programs/computer-science/index.html}{Department of Computer Science}\\
...
\parbox{\rcollength}{%
\textit{Work:}\mytab+1-503-xxx-xxxx \\
\textit{Fax:}\mytab+1-503-xxx-xxxx \\
...
\item[]\href{https://willamette.edu/computer-data-science/programs/computer-science/index.html}{Department of Computer Science}
\item[]\href{https://willamette.edu/computer-data-science/index.html}{Computing \& Data Science}
\end{innerlist}
...
\textbf{Adjunct Professor},
            ...
            \hfill {January 2020 to May 2020}
\begin{innerlist}
\item[]\href{https://www.elon.edu/u/academics/arts-and-sciences/computer-science/}{Department of Computer Science}
    \begin{innerlist}
                \item \href{http://elon.smartcatalogiq.com/en/2020-2021/Academic-Catalog/Courses/CSC-Computer-Science/100/CSC-130}{CSC 130 Computer Science I}
    \end{innerlist}
\end{innerlist}
...
\begin{innerlist}
    ...
    \begin{innerlist}
        ...
        \item Liasons:
            \begin{innerlist}
                \item \href{https://www.intel.com/content/www/us/en/research/overview.html}{Intel Corporation}, Hillsboro, Oregon
                \item \href{https://eda.sw.siemens.com/en-US/}{Mentor Graphics (now: Siemens EDA)}, Wilsonville, Oregon
            \end{innerlist}
    \end{innerlist}
