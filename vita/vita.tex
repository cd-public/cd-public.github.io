...
\begin{bibenum}
	\item C. Deutschbein, A. Stassinopoulos.
		...
		April 2026. \\
		\doi{10.1109/ICECET63943.2025.11472017} 	

	\item C. Deutschbein, J. Ostler.
		RTL-Arrow: Hardware-to-Cloud Bridge\\
		In: \emph{Pacific Northwest Software Quality Conference},
		October 2025. \\
		\url{https://pnsqc.org/archive/proceedings/}

	\item C. Deutschbein, S. Ahmed Antu.
		Engaging with the Wiphala: A Code-Generation Hardened CS1 Final\\
		In: \emph{Consortium for Computing Sciences in Colleges - Rocky Mountain}
		October 2025. \\
		\doi{10.5555/3778141.3778149} 	
...
\begin{bibenum}
	...
	\item RTL-Arrow: Hardware-to-Cloud Bridge\\
    	Quality Jam, Pacific Northwest Software Quality Conference.\\
    	21 January, 2026.

	\item Leveraging Data Science Insights for Hardware Security Research\\
    	Reed College, Computer Science Colloqiuim.\\
    	12 November, 2025.

	\item Hardware Security Seminar\\
   	Portland State University, Computer Science Colloqiuim.\\
    	6 November, 2025.
	...
	\item "The Thinking Game"\\
    	Documentary Screening, Salem Cinema.\\
   	 2 February, 2024.
	...
	3rd Annual INTEL Side Channel Academic Program Workshop 2021. \\
	11 November 2021.
	
	\item Isadora: Automated Information Flow Property Generation for Hardware Designs.\\
	Workshop on Secure RISC-V Architecture Design (secrisc-v'21). \\
	7 November 2021.
	
	\item Creating Information Flow Specifications.\\
	Radix Presentation for Tortuga Logic. \\
	20 August 2021.
...
\section{Student Supervised Research Presentations}

\begin{bibenum}

	\item O. Wyatt, Calvin Deutschbein.
		Constructing Information Flow Paths from Register Transfler Level Trace Data.
		In: \emph{Consortium for Computing Sciences in Colleges - Northwest},
		October 2025. \\


	\item J. DeYoung, Calvin Deutschbein.
		Aphrodite: Security Properties of RISC-V.
		In: \emph{Northwest Scientific Association/American Association for the Advancement of Science - Pacific Division},
		March 2023. \\
